from dp.env import KAFKA_TOPIC_INGEST, KAFKA_TOPIC_RAW, KAFKA_TOPIC_UNIQUE, KAFKA_TOPIC_DE_NORM, KAFKA_TOPIC_DRUID_EVENTS, \
    KAFKA_TOPIC_DUPLICATE, KAFKA_TOPIC_BATCH_DUPLICATE, KAFKA_TOPIC_FAILED
from dp.event import get_batch_event_data


def get_invalid_event_test_data():
    messages = [
