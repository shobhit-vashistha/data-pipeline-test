from dp.env import KAFKA_TOPIC_RAW, KAFKA_TOPIC_DRUID_EVENTS, KAFKA_TOPIC_DE_NORM, KAFKA_TOPIC_UNIQUE, \
    KAFKA_TOPIC_INGEST, KAFKA_TOPIC_BATCH_DUPLICATE, KAFKA_TOPIC_DUPLICATE, KAFKA_TOPIC_FAILED, KAFKA_TOPIC_BATCH_FAILED
...
FILTER_EXTRACT_FUNCTIONS = {
    ...
    KAFKA_TOPIC_FAILED: (filter_by_event_mid_func, extract_mid_set),
    KAFKA_TOPIC_BATCH_FAILED: (filter_by_msg_id_func, extract_msg_id_set),
